//------------------------------------------------------------------------------
// <copyright file="CreateGistPackage.cs" company="Company">
...
namespace Microsoft.VisualStudio.Extensions.Clipper
{
    ...
    {
        /// <summary>
        /// CreateGistPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "0ba53ef1-b7d3-423d-abbf-25f93b6fc7f5";

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGist"/> class.
        /// </summary>
        public CreateGistPackage()
        {
